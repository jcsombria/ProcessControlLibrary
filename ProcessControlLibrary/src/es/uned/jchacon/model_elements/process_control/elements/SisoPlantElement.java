...
public class SisoPlantElement extends AbstractModelElement {
  public static final String ICON_FILE = "es/uned/jchacon/model_elements/process_control/elements/resources/SisoPlant.png";
...
//  regionRunEditor.readPlainCode("// "+ RES.getString("ParallelJava.RegionRun.ToolTip"));
  ...
  public String getGenericName() { return "SisoPlant"; }
  
  public String getConstructorName() { return "es.uned.jchacon.model_elements.process_control.continuous.SisoPlant"; }
  ...
  protected String getHtmlPage() { 
	return "es/uned/jchacon/model_elements/process_control/elements/resources/SisoPlant.html";
  }
