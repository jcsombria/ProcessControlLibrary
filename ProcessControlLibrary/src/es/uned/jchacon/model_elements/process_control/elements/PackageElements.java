...
public class PackageElements {
  ...
  /**
   * Default main for packing the library
   * @param args
   */
  static public void main(String[] args) {
    String commandLine = 
      " -o ../Ejs/distribution/bin/extensions/model_elements/process_control/ProcessControl.jar " + // The output JAR file, to be located under in bin/extensions/model_elements
//      " -m .;../../ejs.jar;../../ejs_lib.jar;../../osp.jar org.colos.ejs.model_elements.input_output.DataReaderElement "+ // To display something and also for EJS to know the main class
      ...
      " org/colos/ejs/model_elements/process_control/++ "; // get ALL files under this directory and its dependencies (for class files)
